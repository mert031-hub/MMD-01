...
export default function WhatsAppButton() {
  ...
  const availabilityText = locale === "tr" ? "Aynı gün yanıt" : "Same-day reply";
  ...
  return (
    <AnimatePresence>
      {show && (
        ...
        >
          {/* Presence dot */}
          <span aria-hidden="true" style={{ position: "relative", width: 6, height: 6, flexShrink: 0 }}>
          ...
          <span style={{ display: "flex", flexDirection: "column", gap: 1 }}>
            <span>{label}</span>
            <span style={{ fontSize: 9, fontWeight: 400, letterSpacing: "0.04em", opacity: 0.55 }}>
              {availabilityText}
            </span>
          </span>
