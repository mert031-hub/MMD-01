  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          {/* WhatsApp primary — wrapped in MagneticButton */}
        ...
        {/* Availability signal — trust microcopy with presence dot */}
        <motion.div
          {...fadeUp(0.38)}
          style={{
            display: "inline-flex",
        ...
        >
          {/* Pulsing green presence indicator */}
          <span
            aria-hidden="true"
            style={{ position: "relative", width: 7, height: 7, display: "inline-block", flexShrink: 0 }}
          >
            <span
              style={{
                position: "absolute",
