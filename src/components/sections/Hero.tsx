  ...
  return (
    <div
      ...
      style={{
        ...
        transition: "transform 300ms cubic-bezier(0,0,0.2,1), box-shadow 300ms ease",
...
function ScrollIndicator({ label, shouldReduce }: { label: string; shouldReduce: boolean }) {
  return (
    <div
      style={{
        position: "absolute",
    ...
    >
      ...
      >
        ...
        <div style={{
          ...
          width: "60%",
          height: "70%",
          background: "radial-gradient(ellipse at center, rgba(6,7,113,0.028) 0%, transparent 70%)",
        }} />
        ...
        <div style={{
          ...
          width: "50%",
          height: "60%",
          background: "radial-gradient(ellipse at center, rgba(255,108,12,0.018) 0%, transparent 70%)",
        }} />
        {/* Micro engineering grid — full section */}
        <div style={{
          position: "absolute",
          inset: 0,
          backgroundImage: "linear-gradient(rgba(6,7,113,0.022) 1px, transparent 1px), linear-gradient(90deg, rgba(6,7,113,0.022) 1px, transparent 1px)",
      ...
      >
        <div className="hero-grid" style={{ width: "100%" }}>
          ...
          <div className="hero-left">
            ...
            {/* Headline with parallax + hover nudge */}
            <motion.h1
            ...
            >
              {/* Primary CTA — magnetic + sweep + glow */}
              <Link
                href="/#iletisim"
                ...
                style={{
                  ...
                  boxShadow: ctaHover && !shouldReduce
                    ? "0 10px 30px rgba(255,108,12,0.38), 0 4px 10px rgba(255,108,12,0.22)"
                    : "none",
                  willChange: "transform",
                }}
              >
          ...
          >
            ...
            >
              ...
              <div style={{ position: "absolute", inset: 0, display: "flex", alignItems: "center", justifyContent: "center", overflow: "hidden", pointerEvents: "none" }}>
                <motion.span
                  animate={shouldReduce ? {} : { opacity: [0.045, 0.07, 0.045] }}
              ...
              >
                <motion.div
                  initial={shouldReduce ? {} : { opacity: 0, scale: 0.92, y: 24 }}
                  animate={{ opacity: 0.88, scale: 1, y: 0 }}
                  transition={{ delay: 0.8, duration: 0.9, ease: EASE_OUT }}
                >
                  <motion.div
                    animate={shouldReduce ? {} : { y: [0, -6, 0], rotate: [0, 0.3, 0] }}
                    transition={shouldReduce ? {} : { duration: 6.5, ease: "easeInOut", repeat: Infinity, repeatType: "loop" }}
                  >
              ...
              >
                <motion.div
                  initial={shouldReduce ? {} : { opacity: 0, y: 36, scale: 0.96 }}
                  animate={{ opacity: 1, y: 0, scale: 1 }}
                  transition={{ delay: 1.05, duration: 0.85, ease: EASE_OUT }}
                >
                  <motion.div
                    animate={shouldReduce ? {} : { y: [0, -8, 0], rotate: [0, -0.4, 0] }}
                    transition={shouldReduce ? {} : { duration: 7.2, ease: "easeInOut", repeat: Infinity, repeatType: "loop" }}
                  >
